...
var Price = function Price() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "price"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(framer_motion__WEBPACK_IMPORTED_MODULE_4__.motion.ul, {
    initial: "hidden",
    whileInView: "visible",
    viewport: {
      amout: 0.1,
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../../img/header-online1.png */ "./src/img/header-online1.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../../img/header-online-desctop1.png */ "./src/img/header-online-desctop1.png"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
var ___CSS_LOADER_URL_REPLACEMENT_1___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_1___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-exer {\n  position: relative;\n  padding-top: 45px;\n  z-index: 3;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.header-exer__img {\n  position: relative;\n  width: 100vw;\n  height: 20vh;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-repeat: no-repeat;\n  background-size: cover;\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n}\n@media (min-width: 575px) {\n  .header-exer__img {\n    height: 50vh;\n    background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n    background-position-y: 50%;\n  }\n}\n.header-exer__text {\n  position: absolute;\n  width: 210px;\n  z-index: 5;\n}\n@media (min-width: 575px) {\n  .header-exer__text {\n    width: 100%;\n  }\n}\n.header-exer__text .title {\n  font-weight: 700;\n  font-size: 24px;\n  color: #fff;\n  text-transform: uppercase;\n  line-height: 40px;\n  text-shadow: 0 0 2px #060606, 0 0 2px #060606;\n}\n@media (min-width: 575px) {\n  .header-exer__text .title {\n    font-size: 30px;\n  }\n}\n@media (min-width: 575px) {\n  .header-exer__text .title {\n    font-size: 40px;\n  }\n}", "",{"version":3,"sources":["webpack://./src/PageVideoCurse/Header/header-exer.scss"],"names":[],"mappings":"AAGA;EACI,kBAAA;EACA,iBAAA;EACA,UAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;AAFJ;AAII;EACI,kBAAA;EACA,YAAA;EACA,YAAA;EACA,yDAAA;EACA,4BAAA;EACA,sBAAA;EACA,2CAAA;AAFR;AAIQ;EATJ;IAUQ,YAAA;IACA,yDAAA;IACA,0BAAA;EADV;AACF;AAII;EACI,kBAAA;EACA,YAAA;EACA,UAAA;AAFR;AAIQ;EALJ;IAMQ,WAAA;EADV;AACF;AAGQ;EACI,gBAAA;EACA,eAAA;EACA,WAAA;EACA,yBAAA;EACA,iBAAA;EACA,6CAAA;AADZ;AAGY;EARJ;IASQ,eAAA;EAAd;AACF;AAEY;EAZJ;IAaQ,eAAA;EACd;AACF","sourcesContent":["\n\n\n.header-exer {\n    position: relative;\n    padding-top: 45px;\n    z-index: 3;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n\n    &__img {\n        position: relative;\n        width: 100vw;\n        height: 20vh;\n        background-image: url(../../img/header-online1.png);\n        background-repeat: no-repeat;\n        background-size: cover;\n        box-shadow: (0px 4px 4px rgba(0, 0, 0, 0.25));\n\n        @media (min-width: 575px) {\n            height: 50vh;\n            background-image: url(../../img/header-online-desctop1.png);\n            background-position-y: 50%;\n        }\n    }\n\n    &__text {\n        position: absolute;\n        width: 210px;\n        z-index: 5;\n\n        @media (min-width: 575px) {\n            width: 100%;\n        }\n\n        .title {\n            font-weight: 700;\n            font-size: 24px;\n            color: #fff;\n            text-transform: uppercase;\n            line-height: 40px;\n            text-shadow: 0 0 2px #060606, 0 0 2px #060606;\n\n            @media (min-width: 575px) {\n                font-size: 30px;\n            }\n\n            @media (min-width: 575px) {\n                font-size: 40px;\n            }\n        }\n    }\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/***/ "./src/img/header-online-desctop1.png":
/*!********************************************!*\
  !*** ./src/img/header-online-desctop1.png ***!
  \********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "assets/9430b8c32685779880a2.png";

/***/ }),

/***/ "./src/img/header-online1.png":
/*!************************************!*\
  !*** ./src/img/header-online1.png ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "assets/c8126584abb909729093.png";
...
/******/ })()
;
//# sourceMappingURL=scripts.398a1337e3966d56ec8e.js.map