...
var Price = function Price() {
  ...
  var price = [{
    ...
    btn: 'Записатись',
    detal: 'Детальніше',
    trg: 'Ця послуга ідеально підходить тим хто травмувався і потребує реабілітації, але не має можливості працювати безпосередньо з реабілітологом. На сеансі проводиться збір анамнезу та цілей реабілітації. Я відповідаю на всі Ваші питання і даю рекомендації. Після цього формую програму реабілітації з вправами  на 2 тижні. ВСІ ГРОШІ З ЦІЄЇ ПОСЛУГИ ЙЛУТЬ НА ЗСУ!!! ВІЙСЬКОВИМ БЕЗКОШТОВНО!!!'
  }, {
    id: 3,
...
/******/ })()
;
//# sourceMappingURL=scripts.894ca2dfd986f828a3e2.js.map